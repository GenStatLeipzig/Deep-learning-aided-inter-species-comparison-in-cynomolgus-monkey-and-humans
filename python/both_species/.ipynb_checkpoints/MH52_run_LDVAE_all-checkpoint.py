...
for celltype in celltypes:
    if celltype != 'NK+Proliferating':
        adata_ct = h.filter_adata_obs(adata=adata,col_name=celltype_col,val=celltype)
    else:
        adata_NK = h.filter_adata_obs(adata=adata,col_name=celltype_col,val='NK')
        adata_NK_prolif = h.filter_adata_obs(adata=adata,col_name=celltype_col,val='NK Proliferating')
